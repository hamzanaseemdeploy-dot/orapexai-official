...
const LegalPage: React.FC<LegalPageProps> = ({ title }) => {
  ...
  return (
    <div className="bg-slate-950 text-white pt-32 px-6 pb-24 relative overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <Link 
          href="/"
          className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition-all mb-12 font-semibold group bg-slate-900/50 px-4 py-2 rounded-full border border-slate-800"
        >
